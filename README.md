...
A custom keyboard PCB for use with Cherry MX (and compatible) switches. Full KiCad project included, plus a fabrication-ready production folder (BOM, CPL, netlist, Gerbers) for ordering directly from a fab house such as JLCPCB.
